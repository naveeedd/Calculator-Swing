...
public class scientificView extends JFrame {
    ...
    private JButton yXButton1;
    private JButton a3XButton1;
        ...
        equalbutton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (Objects.equals(op, "+")){
                    ...
                    result=a/b;
                    history.append(b).append(" = ").append(result).append("\n");
                    txtDisplay.setText(String.valueOf(result));
                }
            }
        });
    ...
    public static void main(String[] args) {
        scientificView scien = new scientificView();
