...
public class Unitview extends JFrame {
    ...
    public JMenuBar MenuBar() {
        ...
        JCheckBoxMenuItem digitGrouping = new JCheckBoxMenuItem("Digit grouping");
        ...
        worksheetsMenu.add(basicWorksheet);
        worksheetsMenu.add(unitConversion);
        worksheetsMenu.add(dateCalculation);
    ...
    private void openNewPage(String pageTitle) {
        ...
        if (pageTitle.equals("Scientific")){
            new scientificView();
            dispose();
        }
    ...
    public static void main(String[] args) {
        Unitview cal = new Unitview();
        cal.setTitle("Calculator");
        cal.setJMenuBar(cal.MenuBar());
        cal.setContentPane(new Unitview().Calculator);
        cal.pack();
